...
export default function App() {
    ...
    setStudentProfile(prev => {
      ...
      setStudents(prevList => {
        ...
        const formattedRecord = {
          ...
          collegeName: merged.institution || merged.collegeName || 'Accredited Institution',
          institution: merged.institution || merged.collegeName || 'Accredited Institution',
          degree: merged.degree || 'B.Tech CS',
          branch: merged.branch || 'Computer Science & Engineering',
          yearOfStudy: merged.yearOfStudy || merged.currentYearOrSemester || '3rd Year',
          currentYearOrSemester: merged.yearOfStudy || merged.currentYearOrSemester || '3rd Year',
          ...
          skills: Array.isArray(merged.skills) ? merged.skills : (merged.skills ? merged.skills.split(',').map(s => s.trim()) : ['React', 'JavaScript']),
          resumeUrl: merged.resumeUrl || merged.resumeLink || 'https://resume.interncatalyst.org/view',
          resumeLink: merged.resumeUrl || merged.resumeLink || 'https://resume.interncatalyst.org/view',
  ...
  const handleConfirmApply = async (internshipId, formData) => {
    ...
    const newApp = {
      ...
      studentCollege: formData.college || studentProfile.institution || 'Indian Institute of Technology, Bombay',
      studentDegree: formData.course || studentProfile.degree || 'B.Tech Computer Science',
      studentYear: formData.yearOfStudy || '3rd Year',
      studentCgpa: studentProfile.cgpa || '8.85 / 10',
      studentSkills: studentProfile.skills || ['React', 'Node.js', 'JavaScript'],
